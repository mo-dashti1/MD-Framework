...
class MD_Model_Mysql implements MD_Model_Interface
{
	private $db_params;
	...
	/**
	 * (non-PHPdoc)
	 * @see MD_Model_Interface::connect()
	 */
	public function connect()
	{
		 
		$this->connection = mysql_connect($this->db_params['host'],$this->db_params['username'],$this->db_params['password'])
		or die(mysql_errno());
		if($this->connection)
		{
			mysql_select_db($this->db_params['dbname']);
		}else 	
			return false;
		return true;
	}
