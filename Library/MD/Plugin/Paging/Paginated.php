...
class Paginated {
	...
	public function fetchPagedNavigation($baseurl = '',$directions = array('first'=>"First",'previous'=>"previous",'next'=>"next",'last'=>"Last"), $queryVars = "") {
		return $this->getLayout()->fetchPagedLinks($baseurl, $this, $queryVars, $directions );
	}//end writeNavigation
}//end Paginated
?>